...
const PATHS = {
  ...
  'box-open': '<path d="M3 8.5 12 4l9 4.5"/><path d="M3 8.5V17l9 4 9-4V8.5"/><path d="m3 8.5 9 4.5 9-4.5"/><path d="M12 13v8"/>',
  ...
  shield_user: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><circle cx="12" cy="10" r="2.5"/>',
  lock: '<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
  'id-card': '<rect width="20" height="14" x="2" y="5" rx="2"/><circle cx="8" cy="11" r="2"/><path d="M5 17c.6-1.5 1.8-2 3-2s2.4.5 3 2"/><path d="M14 10h5M14 14h4"/>',
